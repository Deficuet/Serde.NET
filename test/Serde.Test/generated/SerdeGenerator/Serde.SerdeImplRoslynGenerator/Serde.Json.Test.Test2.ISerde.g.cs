...
partial class Test2
{
    sealed partial class _SerdeObj : global::Serde.ISerde<Serde.Json.Test.Test2>
    {
        global::Serde.ISerdeInfo global::Serde.ISerdeInfoProvider.SerdeInfo => Serde.Json.Test.Test2.s_serdeInfo;

        void global::Serde.ISerialize<Serde.Json.Test.Test2>.Serialize(Serde.Json.Test.Test2 value, global::Serde.ISerializer serializer)
        {
            ...
            _l_type.WriteBoxedValue<System.Numerics.Vector4, Serde.Json.Test.Vector4Proxy>(_l_info, 4, value.v4);
            _l_type.End(_l_info);
        }
        Serde.Json.Test.Test2 Serde.IDeserialize<Serde.Json.Test.Test2>.Deserialize(IDeserializer deserializer)
        {
            ...
            System.Numerics.Vector4 _l_v4 = default!;
            ...
            while (true)
            {
                ...
                switch (_l_index_)
                {
                    ...
                    case 4:
                        ...
                        _l_v4 = typeDeserialize.ReadBoxedValue<System.Numerics.Vector4, Serde.Json.Test.Vector4Proxy>(_l_serdeInfo, _l_index_);
            ...
            var newType = new Serde.Json.Test.Test2() {
                v2 = _l_v2,
