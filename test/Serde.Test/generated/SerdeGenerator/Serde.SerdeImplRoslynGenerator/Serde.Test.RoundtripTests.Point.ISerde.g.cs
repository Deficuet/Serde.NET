...
partial class RoundtripTests
{
    ...
    {
        sealed partial class _SerdeObj : global::Serde.ISerde<Serde.Test.RoundtripTests.Point>
        {
            global::Serde.ISerdeInfo global::Serde.ISerdeInfoProvider.SerdeInfo => Serde.Test.RoundtripTests.Point.s_serdeInfo;
            ...
            Serde.Test.RoundtripTests.Point Serde.IDeserialize<Serde.Test.RoundtripTests.Point>.Deserialize(IDeserializer deserializer)
            {
                int _l_x = default!;
                int _l_y = default!;
                ...
                var newType = new Serde.Test.RoundtripTests.Point() {
                    X = _l_x,
                    Y = _l_y,
                };
